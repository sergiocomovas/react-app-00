...
*  https://wdrfree.com/254/how-to-create-simple-css-grid-system `;
    ...
    return (
        ...
        <div style={{border: "2px solid #FFF",borderRadius: "10px 10px", overflowX:"scroll", Width: "100%", whiteSpace:"nowrap"}} className="row">
            <div id="s1"style={{borderRadius: "8px 0px 0px 8px", backgroundColor: "Red", textAlign: "center"}} className={col.row1classname}>🌹<br></br>Rojo<br></br><code id="s1s">.{col.row4classname}</code></div>
            <div id="s2" style={{backgroundColor: "Blue", textAlign: "center"}}className={col.row2classname}>💧<br></br>Azul<br></br><code id="s2s">.{col.row4classname}</code></div>
            <div id="s3" style={{backgroundColor: "Green", textAlign: "center"}} className={col.row3classname}>🥦 <br></br>Verde<br></br><code id="s3s">.{col.row4classname}</code></div>
